...
///
/// This version allows inheritance for contracts behind a proxy.
contract OwnableInitializable is Initializable {
    ...
    function initialize(address[] memory owners) internal initializer {
        uint i;
